...
@Composable
fun PlayerInGameContent(players: List<Player>, addPlayer: (Player) -> Unit, removePlayer: (Player) -> Unit, modifier: Modifier = Modifier) {
    Column(
        modifier = modifier
            .fillMaxWidth()
            .padding(16.dp),
        ...
        AddPlayerForm(onNewPlayer = addPlayer)
        PlayersList(
            players = players,
